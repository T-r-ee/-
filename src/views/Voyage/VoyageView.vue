...
export default {
  ...
  data() {
    return {
      navArray: [
        { name: "信息总览", check: true, url: "/voyage/overview" },
        { name: "主机", check: false, url: "/voyage/host" },
        { name: "发电机", check: false, url: "/voyage/dynamo" },
        { name: "PMS", check: false , url: "/voyage/pms"},
        { name: "油水状态", check: false , url: "/voyage/oilwater"},
        { name: "辅助设备", check: false, url: "/voyage/auxiliary" },
        { name: "安全设备", check: false , url: "/voyage/safe"},
        { name: "北斗回传数据", check: false,url: "/voyage/beidou" },
        { name: "能源管理", check: false, url: "/voyage/energy" },
      ],
      activeIndex: "1",
      activeIndex2: "1",
      asidelist: {
...
.main {
  ...
  .container {
    flex: 1;
    display: flex;
    background: url(../../assets/voyageBack.png)
      100% no-repeat;
    background-size: 100% 100%;
    margin-top: 14px;
    // padding: 10px;
